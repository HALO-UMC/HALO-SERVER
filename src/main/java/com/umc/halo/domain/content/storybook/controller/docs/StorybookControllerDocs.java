...
public interface StorybookControllerDocs {
    ...
    @Operation(
            ...
            description = """
                    ...
                    온보딩 시 선택한 목적 태그를 기반으로 추천 스토리북을 조회합니다.
                    ...
                    2. 태그와 매칭되는 스토리북 중 이미 시작(진행중/완료)한 스토리북을 제외하고, 우선순위(PRIMARY > SECONDARY) 순으로 정렬합니다.
                    3. 매칭된 스토리북이 2개 미만이면, 아직 시작하지 않은 스토리북을 storybookId 순서를 기준으로 채웁니다.
                    4. 최대 2개의 추천 스토리북을 반환합니다. 이미 시작/완료한 스토리북이 많아 후보가 부족하면 2개보다 적게(0~1개) 반환될 수 있습니다.
                    """
    )
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
