    ...
    public List<Chapter> seedChapter(Storybook storybook) {
        List<Chapter> chapters = List.of(
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(3)
                        .title("부모님의 속도")
                        .shortImageUrl("https://example.com/chapter3-short.png")
                        .longImageUrl("https://example.com/chapter3-long.png")
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(4)
                        .title("함께 장보기")
                        .shortImageUrl("https://example.com/chapter4-short.png")
                        .longImageUrl("https://example.com/chapter4-long.png")
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(5)
                        .title("가까운 외출")
                        .shortImageUrl("https://example.com/chapter5-short.png")
                        .longImageUrl("https://example.com/chapter5-long.png")
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(6)
                        .title("오래된 장소")
                        .shortImageUrl("https://example.com/chapter6-short.png")
                        .longImageUrl("https://example.com/chapter6-long.png")
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(7)
                        .title("오늘의 사진 한 장")
                        .shortImageUrl("https://example.com/chapter7-short.png")
                        .longImageUrl("https://example.com/chapter7-long.png")
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(8)
                        .title("조금 먼 곳")
                        .shortImageUrl("https://example.com/chapter8-short.png")
                        .longImageUrl("https://example.com/chapter8-long.png")
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(9)
                        .title("돌아오는 길")
                        .shortImageUrl("https://example.com/chapter9-short.png")
                        .longImageUrl("https://example.com/chapter9-long.png")
                ...
                Chapter.builder()
                        ...
                        .chapterOrder(10)
                        .title("나란히 걷는 우리")
                        .shortImageUrl("https://example.com/chapter10-short.png")
                        .longImageUrl("https://example.com/chapter10-long.png")
